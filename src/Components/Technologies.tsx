...
const Technologies = ({ darkMode }: { darkMode: boolean }) => {
  return (
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        ...
        <div className="rounded-2xl border-4 border-neutral-400 dark:border-neutral-800 p-4">
          {darkMode && "dark" ? (
            ...
            <TbBrandNextjs className="text-7xl text-neutral-800" />
          )}
        ...
        <div className="rounded-2xl border-4 border-neutral-400 dark:border-neutral-800 p-4">
          {darkMode && "dark" ? (
            ...
            <BsGithub className="text-7xl text-neutral-800" />
          )}
        ...
        <div className="rounded-2xl border-4 border-neutral-400 dark:border-neutral-800 p-4">
          {darkMode && "dark" ? (
            ...
            <SiExpress className="text-7xl text-neutral-800" />
          )}
